...
%
% Inputs:
% - fil_num,fil_den: achieved from 'hrf_filters' function. fil_num = 
% numerator part, finite length filtering (FIR); fil_den = denominator 
% part, infinte length filtering (IIR) causal or uncausal
% - in: input
% - condition: 'normal'/'transpose' (if we apply the filter to the time 
% inversed version of the signal x(-t); corresponds to the conjugate 
% transpose)
%
% Outputs:
% - out is the result of the filtering operation
%
