%% This function maps input data to a desired output dimension
%
% Inputs:
% - Vin is a 3D volume with the data to map
% - Vin_i contains the header (from a .nii) with dimension information for
% the input data
% - Vout_i contains the same information for the output data header
% (desired output space details)
%
% Outputs:
% - Vout contains the output data as a 3D volume
%
% Implemented by Jonas Richiardi
function Vout=mapVTV(Vin,Vin_i,Vout_i)
